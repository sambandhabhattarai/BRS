...
<!-- NavBar code -->
 ...
 <form 	 action="payment"  method="get">
        ...
        <table>
            <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat1" value="1">
                    <label for="seat1">1</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat2" value="2">
                    <label for="seat2">2</label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat3" value="3">
                    <label for="seat3">3</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat4" value="4">
                    <label for="seat4">4</label>
                </td>
            </tr>
               <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat5" value="5 ">
                    <label for="seat5">5</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat6" value="6">
                    <label for="seat6">6</label>
                </td>
            </tr>
               <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat7" value="7">
                    <label for="seat7">7</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat8" value="8">
                    <label for="seat8">8</label>
                </td>
            </tr>
               <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat9" value="9">
                    <label for="seat9">9</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat10" value="10">
                    <label for="seat10">10</label>
                </td>
            </tr>
               <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat11" value="11">
                    <label for="seat11">11</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat12" value="12">
                    <label for="seat12">12</label>
                </td>
            </tr>
               <tr>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat13" value="13">
                    <label for="seat13">13</label>
                </td>
                <td>
                    <input type="checkbox" name="seatnumber" id="seat14" value="14">
...
<script>
  // Function to open the seat details popup
  function openPopup() {
...
<input type="submit" value="Submit" style="background-color: #4070f4; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; width: 100%; margin-top:20px;" />
  ...
  //script for number of people
  // Function to randomly select seats for the specified number of people
function selectRandomSeats(numPeople) {
    const seats = document.querySelectorAll("li.seat input[type='checkbox']");
    const availableSeats = [...seats].filter(seat => !seat.checked && !seat.disabled);

    if (availableSeats.length < numPeople) {
        alert("Not enough available seats for the requested number of people.");
        return;
    }
    ...
    // Select the first 'numPeople' seats
    for (let i = 0; i < numPeople; i++) {
        availableSeats[i].checked = true;
        openPopup(availableSeats[i].parentNode);
    }
}

// Add an event listener to the "Number of People" input field
const numPeopleInput = document.getElementById("numPeople");
numPeopleInput.addEventListener("input", () => {
    const numPeople = parseInt(numPeopleInput.value, 10);
    if (!isNaN(numPeople)) {
        selectRandomSeats(numPeople);
    }
});
